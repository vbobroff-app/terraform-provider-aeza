...
|`Base` | float64 | Базовое значение | `2.0`, `4.0`, `60.0` |
...
| Поле | Тип | Описание | Пример |
|------|-----|----------|---------|
|`Hour` | float64 | Почасовая оплата | `3.0`, `5.0`, `24.0` |
|`Month` | float64 | Помесячная оплата | `707.0`, `1415.0`, `11844.0` |
|`Year` | float64 | Годовая оплата | `7466.0`, `14943.0`, `125073.0` |
|`HalfYear` | float64 | Полугодовая оплата | `3862.0`, `7723.0`, `64668.0` |
|`QuarterYear` | float64 | Квартальная оплата | `2016.0`, `4032.0`, `33755.0` |
