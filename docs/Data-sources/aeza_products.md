...
Получает список [доступных продуктов Aeza](../API/products.md). Используется для получения информации о конфигурациях, ценах и типах сервисов перед созданием ресурсов.
