...
Получает список доступных типов услуг в Aeza. Используется для определения поддерживаемых категорий сервисов (VPS, выделенные серверы и т.д.) перед созданием ресурсов.
